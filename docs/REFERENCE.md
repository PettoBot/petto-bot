# Petto technical reference

This document contains the complete command catalog, setup instructions,
permissions, architecture notes, and deployment reference. The short project
overview lives in the repository root [README](../README.md).
